...
> · [interface prototypes](https://fusovaadmin.github.io/inspection-quality-intelligence/demos/)
>
> The prototypes under `demos/` are hand-built interface sketches — not pipeline
> output, not test-covered, and their figures are illustrative rather than computed.
> Everything else on the site is generated by the CI-gated pipeline.
